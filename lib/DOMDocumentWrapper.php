    ...
    protected function contentTypeFromHTML($markup) {
       // var_dump($markup);exit;
        ...
        if (! isset($matches[0])) {
            ...
            if(isset($matches[2])) {
             //   $matches[2] standar is  content="text/html;charset=utf-8"
                $matches[2] = 'content="text/html;charset='.$matches[2]; //simulate normal formulation  content="text/html;charset=utf-8"
            }
            if(! isset($matches[0])) {
