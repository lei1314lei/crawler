...
class Zend_Http_Client
{
    ...
    protected function _prepareBody()
    {
       // var_dump($this->raw_post_data);
        ...
        if (count($this->paramsPost) > 0 || count($this->files) > 0) {
            switch($this->enctype) {
                ...
                case self::ENC_URLENCODED:
                    ...
                    $body = "data={\"section\":1,\"amount-pages\":21,\"articles-per-site\":20}";
        ...
        //return json_encode( $data = array("data" => array('section'=>1,'amount-pages'=>21,'articles-per-site'=>20)));
     //   return  $this->paramsPost;
